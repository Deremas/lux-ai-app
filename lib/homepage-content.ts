...
const englishCopy: HomePageCopy = {
  hero: {
    ...
    urgency: "Luxembourg-based · GDPR-ready systems · Built for SMEs across Europe.",
...
const frenchCopy: HomePageCopy = {
  hero: {
    ...
    urgency: "Base au Luxembourg · Systemes prets RGPD · Concu pour les PME en Europe.",
...
const germanCopy: HomePageCopy = {
  hero: {
    ...
    urgency: "Standort Luxemburg · DSGVO-taugliche Systeme · Gebaut fuer KMU in Europa.",
...
const luxembourgishCopy: HomePageCopy = {
  hero: {
    ...
    urgency: "Lëtzebuerg · GDPR-prett Systemer · Fir PMEen an Europa gebaut.",
