...
const sharedLocaleOverrides: Partial<Record<AppLanguage, LocaleOverrides>> = {
  ...
  fr: {
    ...
    processSteps: [
      { step: "Évaluer", description: "Comprendre le workflow actuel, identifier les blocages et définir les meilleures opportunités d’automatisation.", points: ["Cartographie du workflow", "Revue des outils et données", "Définition du cas d’usage prioritaire", "Liste courte des opportunités"] },
      { step: "Concevoir", description: "Traduire les besoins métier en une architecture pratique avec les bons systèmes et la bonne logique.", points: ["Architecture de solution", "Choix des outils", "Règles métier et logique de routage", "Plan d’implémentation"] },
      { step: "Construire", description: "Implémenter les workflows, configurer les systèmes IA et connecter les outils qui doivent fonctionner ensemble.", points: ["Configuration des workflows", "Configuration des assistants IA", "Intégration API et systèmes", "Tests et transfert"] },
      { step: "Optimiser", description: "Mesurer la performance, affiner le flux et améliorer les résultats métier une fois le système en production.", points: ["Suivi et feedback", "Amélioration du workflow", "Qualité des réponses", "Reporting opérationnel"] },
      { step: "Maintenir", description: "Assurer un accompagnement continu pour les entreprises qui ont besoin de monitoring, d’améliorations et de nouvelles demandes.", points: ["Maintenance et support", "Nouvelles demandes d’automatisation", "Mises à jour système", "Optimisation continue"] },
    ],
    teamMembers: [
  ...
  de: {
    ...
    processSteps: [
      { step: "Analysieren", description: "Den aktuellen Workflow verstehen, Engpässe identifizieren und die besten Automatisierungschancen definieren.", points: ["Workflow-Mapping", "Review von Tools und Daten", "Definition des Prioritäts-Use-Case", "Shortlist der Automatisierungschancen"] },
      { step: "Konzipieren", description: "Geschäftsanforderungen in eine praktikable Automatisierungsarchitektur übersetzen.", points: ["Lösungsarchitektur", "Tool-Auswahl", "Geschäftsregeln und Routing-Logik", "Implementierungsplan"] },
      { step: "Umsetzen", description: "Workflows implementieren, KI-Systeme konfigurieren und die Tools verbinden, die zusammenarbeiten müssen.", points: ["Workflow-Setup", "Konfiguration des KI-Assistenten", "API- und Systemintegration", "Tests und Übergabe"] },
      { step: "Optimieren", description: "Leistung messen, den Ablauf verfeinern und Geschäftsergebnisse verbessern, sobald das System live läuft.", points: ["Monitoring und Feedback", "Workflow-Verfeinerung", "Verbesserung der Antwortqualität", "Operatives Reporting"] },
      { step: "Betreuen", description: "Laufende Unterstützung für Unternehmen, die Monitoring, Verbesserungen und neue Automatisierungswünsche benötigen.", points: ["Wartung und Support", "Neue Automatisierungsanforderungen", "System-Updates", "Kontinuierliche Optimierung"] },
    ],
    teamMembers: [
  ...
  lb: {
    ...
    processSteps: [
      { step: "Analyséieren", description: "De aktuelle Workflow verstoen, Engpäss erkennen an déi bescht Automatiséierungs-Opportunitéiten definéieren.", points: ["Workflow-Mapping", "Review vu Tools an Donnéeën", "Definitioun vum Prioritéits-Use-Case", "Shortlist vun Opportunitéiten"] },
      { step: "Entwërfen", description: "Business-Bedierfnesser an eng praktesch Automatiséierungsarchitektur iwwersetzen.", points: ["Léisungsarchitektur", "Tool-Auswiel", "Business-Regelen a Routing-Logik", "Ëmsetzungsplang"] },
      { step: "Bauen", description: "Workflows ëmsetzen, KI-Systemer konfiguréieren an d'Tools verbannen, déi zesummeschaffe mussen.", points: ["Workflow-Setup", "Konfiguratioun vum KI-Assistent", "API- a Systemintegratioun", "Tester an Iwwergab"] },
      { step: "Optimiséieren", description: "Leeschtung moossen, de Flow verfeineren an d'Business-Resultater verbesseren, wann de System live ass.", points: ["Monitoring a Feedback", "Workflow-Verfeinerung", "Verbesserung vun der Äntwertqualitéit", "Operative Reporting"] },
      { step: "Betreien", description: "Weider Ënnerstëtzung fir Betriber, déi Monitoring, Verbesserungen an nei Ufroe brauchen.", points: ["Maintenance a Support", "Nei Automatiséierungsufroen", "System-Updates", "Kontinuéierlech Optimiséierung"] },
    ],
    teamMembers: [
