  ...
  return (
    ...
    >
      ...
      <SidebarInset className="min-w-0 w-0 flex-1 bg-transparent">
        <div className="fixed left-0 right-0 top-[var(--site-header-height)] z-40 md:hidden">
          <MobileMenuBar />
        </div>
        <div className="flex min-h-0 flex-1 flex-col overflow-x-hidden pb-12 pt-14 md:pt-0">
          {children}
        </div>
      </SidebarInset>
    </SidebarProvider>
